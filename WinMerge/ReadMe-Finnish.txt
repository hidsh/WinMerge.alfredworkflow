...
Uusin WinMerge versio ja tiedot ovat saatavilla osoitteessa http://winmerge.org/.

Pika-aloitus
============
Lisätietoja WinMergen perustoiminnoista saat klikkaamalla Ohje>WinMerge Ohje ja siirtymällä Pikakäynnistys-aiheisiin. Tai mene verkkoversioon http://manual.winmerge.org/QuickStart.html.
...
Voit myös selata WinMerge ohjeen HTML-versiota sivuilla http://manual.winmerge.org/.

Arkistointituki
===============
WinMerge käyttää 7-Zip (http://www.7-zip.org) avoimen lähdekoodin arkistointityökalua arkistotiedostojen tukeen. Suosittelemme, että asennat 7-Zip sovelluksen lataamalla ja suorittamalla 7-Zip lisäosa-asentajan sivuilta http://winmerge.org/downloads/.
...
WinMerge tuki
=============
Kysymyksiä tai ehdotuksia WinMergestä? Hyvä paikka aloittaa on WinMerge yhteisön ilmoitustaulu http://forums.winmerge.org/. Kehittäjät lukevat ja vastaavat kysymyksiin molemmilla foorumeilla. Käytä avointa keskustelufoorumia yleisiin WinMerge-kysymyksiin, kuten kysymyksiä käytöstä. Käytä kehittäjien foorumia WinMergen tuotekehityskysymyksiin.

Viat ja ominaisuuspyynnöt
=========================
Jos ongelma ei ratkennut WinMerge-foorumeilla, tarkista projektin seuraajista: Siirry http://project.winmerge.org/ ja klikkaa linkkiä Trackers-valikosta ->Viat ja pyynnöt, jossa voit selata tai lähettää yksityiskohtia.
